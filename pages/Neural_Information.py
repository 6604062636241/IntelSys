...
st.image("./imgs/1.png", caption="", use_column_width=True)
...
st.image("./imgs/2.png", caption="", use_column_width=True)

st.write("ทำ Data Augmentation เพื่อเพิ่มความยากในการฝึก")
st.image("./imgs/3.png", caption="", use_column_width=True)

st.write("ทำ Normalization โดยแปลงค่า pixel ของภาพจากช่วง 0-255 เป็น 0-1")
st.image("./imgs/4.png", caption="", use_column_width=True)

st.write("ปรับขนาดของภาพทั้งหมดเป็น 224x224 pixel และทำการ train")
st.image("./imgs/5.png", caption="", use_column_width=True)
...
st.image("./imgs/6.png", caption="", use_column_width=True)
...
st.image("./imgs/7.png", caption="", use_column_width=True)
